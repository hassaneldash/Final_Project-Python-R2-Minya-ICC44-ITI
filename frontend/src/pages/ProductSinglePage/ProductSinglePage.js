          ...
          <div className='product-single-content bg-white grid'>
            <div className='product-single-l'>
              <div className='product-img '>
                ...
                <img src={product ? (product.images ? product.images[selectedImage] : "") : ""} alt="" className='img-cover' />
                </div>

                <div className='product-img-thumbs flex align-center my-2 img-fluid'>
                  {product && product.images && product.images.map((image, index) => (
                    <div className='thumb-item img-fluid' key={index} onClick={() => handleThumbnailClick(index)}>
                      <img src={image} alt="" className='img-cover img-fluid' />
                    </div>
                  ))}
                </div>
              </div>
