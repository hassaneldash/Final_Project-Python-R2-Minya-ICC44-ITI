...
const fetchFromLocalStorage = () => {
  ...
  if (cart) {
    ...
    // If 'cart' key doesn't exist in localStorage, fetch the initial state from sessionStorage
...
const copySessionToLocalStorage = () => {
  const sessionCart = sessionStorage.getItem("login");
  if (sessionCart) {
